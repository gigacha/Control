...
def serWrite(speed, steering, cnt, cur_mode, cur_speed):
    ...
    elif cur_mode=='ctrl_jump':
        action_jump()

    elif cur_mode=='ctrl_fast':
        speed = 130
...
def getSyncMsg(msg):
    ...
    if cur_mode == 'ctrl_normal' :
        if path_idx != len(path_k):
            if path_k[path_idx] >  100000 :  # if path_k[path_idx] != 0
...
def main(): 
    ...
    #with open('/home/wego/catkin_ws/src/master/serc/waypoint/k-city_test5.csv', mode='r') as csv_file:
